...
class ClaudeAdapter(LLMAdapter):
    async def convert_conversation(self, conversation, system_prompt=None):
    ...
    async def convert_message(self, message, index):
        # Alternating roles based on message index

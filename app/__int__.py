...
from app.config import SLACK_BOTS, CACHE_TYPE, CACHE_DEFAULT_TIMEOUT, MYSQL_HOST, MYSQL_PORT, MYSQL_USER, MYSQL_PASSWORD, MYSQL_DB
...
def create_app():
    ...
    flask_app.config['CACHE_DEFAULT_TIMEOUT'] = CACHE_DEFAULT_TIMEOUT
